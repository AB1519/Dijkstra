...
public class WeighedAdjacencyList<WeighedgraphEdge> {
    private HashMap<Integer, ArrayList<WeighedgraphEdge>> adj = new HashMap(); // adjacency-list

    public WeighedAdjacencyList() {}
     ...
     * @throws IOException
     */
    public WeighedAdjacencyList(String file) throws IOException {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            if (parts.length == 3) {
               ...
               // addEdge(new WeighedgraphEdge(from, to, weight));
            }
        }
    }
     ...
     */
    public ArrayList<WeighedgraphEdge> edgesOf(int vertex) {
     ...
     */
    public ArrayList<WeighedgraphEdge> edges() {
        ArrayList list = new ArrayList<WeighedgraphEdge>();

        for (int from : adj.keySet()) {
            ArrayList<WeighedgraphEdge> currentEdges = adj.get(from);
            for (WeighedgraphEdge e : currentEdges) {
                list.add(e);
            }
        }
        return list;
    ...
    public Iterable<Integer> vertices() {
        ...
        for (WeighedgraphEdge edge : edges()) {
            set.add((edge).from());
            set.add(edge.to());
        }
    ...
    public String toString() {
        ...
        for (int from : adj.keySet()) {
            ...
            for (WeighedgraphEdge edge : currentEdges)
     ...
     * @param newEdge
     */
   // public void addEdge(WeighedgraphEdge newEdge) {
